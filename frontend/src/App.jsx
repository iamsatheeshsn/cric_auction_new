                ...
                <Router>
                  <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-white transition-colors duration-300">
                    ...
                    <Routes>
                      ...
                      {/* Admin Routes */}
                      <Route path="/admin/permissions" element={<ProtectedRoute><MenuPermissions /></ProtectedRoute>} />
                      <Route path="/admin/sponsors" element={<ProtectedRoute><SponsorSettings /></ProtectedRoute>} />
                    </Routes>
