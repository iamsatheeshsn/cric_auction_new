...
const SpectatorLiveRoom = ({ auctionId }) => {
    ...
    if (!auction) return <div className="h-full flex items-center justify-center text-white text-2xl font-bold font-mono tracking-widest animate-pulse">CONNECTING TO FEED...</div>;
    ...
    return (
        <div className="flex-1 flex relative z-10 p-4 lg:p-8 gap-4 lg:gap-8 items-stretch min-h-0 h-full">
...
export default SpectatorLiveRoom;
